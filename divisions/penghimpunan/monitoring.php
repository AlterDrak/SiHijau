...
<!DOCTYPE html>
<html lang="id">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Monitoring - Penghimpunan</title>
<style>
...
.card h2{color:#28a745;margin-bottom:1rem}
.card p{color:#666;line-height:1.6}
</style></head>
<body>
<header class="header"><h1>📊 Monitoring Campaign</h1><a href="index.php" class="back-btn">← Kembali</a></header>
<div class="container"><div class="card">
<h2>🚧 Halaman dalam Pengembangan</h2>
<p>Fitur monitoring progress campaign, laporan harian, & analisis donatur akan segera ditambahkan.<br><br>
 <strong>Tip:</strong> Gunakan halaman ini untuk mencatat target penghimpunan mingguan/bulanan.</p>
</div></div></body></html>