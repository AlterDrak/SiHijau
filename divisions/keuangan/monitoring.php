...
<!DOCTYPE html>
<html lang="id">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Monitoring Keuangan</title>
<style>
...
.card h2{color:#0b5345;margin-bottom:1rem}
.card p{color:#666;line-height:1.6}
</style></head>
<body>
<header class="header"><h1> Monitoring Keuangan</h1><a href="index.php" class="back-btn">← Kembali</a></header>
<div class="container"><div class="card">
<h2>🚧 Halaman dalam Pengembangan</h2>
<p>Fitur rekonsiliasi bank, laporan arus kas bulanan, & export PDF akan segera ditambahkan.<br><br>
💡 <strong>Tip:</strong> Gunakan halaman ini untuk mencocokkan mutasi bank dengan transaksi yang sudah diverifikasi.</p>
</div></div></body></html>