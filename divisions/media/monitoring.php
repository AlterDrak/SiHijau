...
<!DOCTYPE html>
<html lang="id">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Monitoring - Media</title>
<style>
...
.card h2{color:#6f42c1;margin-bottom:1rem}
.card p{color:#666;line-height:1.6}
</style></head>
<body>
<header class="header"><h1>📊 Monitoring Media</h1><a href="index.php" class="back-btn">← Kembali</a></header>
<div class="container"><div class="card">
<h2> Halaman dalam Pengembangan</h2>
<p>Fitur monitoring publikasi, upload dokumentasi, & analitik media sosial akan segera ditambahkan.<br><br>
💡 <strong>Tip:</strong> Gunakan halaman ini untuk menjadwalkan konten & mengarsipkan foto kegiatan.</p>
</div></div></body></html>